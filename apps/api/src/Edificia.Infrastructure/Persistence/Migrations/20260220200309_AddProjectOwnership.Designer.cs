...
namespace Edificia.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260220200309_AddProjectOwnership")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edificia.Domain.Entities.ProjectMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Edificia.Domain.Entities.Project", b =>
                {
                    b.HasOne("Edificia.Domain.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_projects_users_created_by_user_id");
            ...
            modelBuilder.Entity("Edificia.Domain.Entities.ProjectMember", b =>
                {
                    b.HasOne("Edificia.Domain.Entities.Project", "Project")
                        .WithMany("Members")
